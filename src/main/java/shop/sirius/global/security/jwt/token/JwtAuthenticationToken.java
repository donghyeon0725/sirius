package shop.sirius.global.security.jwt.token;
...
public class JwtAuthenticationToken extends AbstractAuthenticationToken {
    ...
    public Collection<GrantedAuthority> getAuthorities() {
        List<HashMap> list = (List<HashMap>)Jwts.parser().setSigningKey(this.secretKey).parseClaimsJws(this.token).getBody().get(SecurityKey.ROLES.getKey());
